...
<package name="ADAFRUIT_CC3000_WIFI">
...
<pad name="IRQ" x="-13.97" y="-9.779" drill="0.9652"/>
<pad name="VBEN" x="-13.97" y="-7.239" drill="0.9652"/>
<pad name="CS" x="-13.97" y="-4.699" drill="0.9652"/>
<pad name="MOSI" x="-13.97" y="-2.159" drill="0.9652"/>
<pad name="MISO" x="-13.97" y="0.381" drill="0.9652"/>
<pad name="CLK" x="-13.97" y="2.921" drill="0.9652"/>
<pad name="VIN" x="-13.97" y="5.461" drill="0.9652"/>
<pad name="3_3V" x="-13.97" y="8.001" drill="0.9652"/>
<pad name="GND" x="-13.97" y="10.541" drill="0.9652"/>
<text x="-16.1798" y="13.335" size="1.27" layer="21" rot="R270">GND</text>
<text x="-15.0368" y="7.366" size="1.016" layer="21" rot="R90">3V</text>
<text x="-14.859" y="3.8862" size="1.27" layer="21" rot="R90">VIN</text>
<text x="-14.859" y="2.1844" size="0.762" layer="21" rot="R90">CK</text>
<text x="-14.9352" y="-0.3048" size="1.27" layer="21" rot="R90">MI</text>
<text x="-15.0114" y="-3.302" size="1.27" layer="21" rot="R90">MO</text>
<text x="-14.9606" y="-6.2484" size="1.27" layer="21" rot="R90">CS</text>
<text x="-14.9352" y="-8.9916" size="1.27" layer="21" rot="R90">VB</text>
<text x="-14.8844" y="-11.5316" size="1.27" layer="21" rot="R90">IQ</text>
...
<text x="-8.89" y="1.27" size="1.27" layer="51">Adafruit CC3000 Wifi</text>
</package>
...
<symbol name="ADAFRUIT_CC3000_WIFI">
<pin name="VBEN" x="-2.54" y="-10.16" visible="pin" length="middle"/>
<pin name="CS" x="-2.54" y="-7.62" visible="pin" length="middle"/>
<pin name="MOSI" x="-2.54" y="-5.08" visible="pin" length="middle"/>
<pin name="MISO" x="-2.54" y="-2.54" visible="pin" length="middle"/>
<pin name="CLK" x="-2.54" y="0" visible="pin" length="middle"/>
<pin name="VIN" x="-2.54" y="2.54" visible="pin" length="middle" direction="pwr"/>
...
<pin name="IRQ" x="-2.54" y="-12.7" visible="pin" length="middle"/>
<text x="17.78" y="-2.54" size="1.778" layer="97">AdaFruit
CC3000
WiFi</text>
</symbol>
...
<deviceset name="ADAFRUIT_CC3000_WIFI">
<gates>
<gate name="G$1" symbol="ADAFRUIT_CC3000_WIFI" x="-15.24" y="2.54"/>
</gates>
<devices>
<device name="" package="ADAFRUIT_CC3000_WIFI">
<connects>
<connect gate="G$1" pin="3V3" pad="3_3V"/>
...
<connect gate="G$1" pin="VBEN" pad="VBEN"/>
<connect gate="G$1" pin="VIN" pad="VIN"/>
</connects>
<technologies>
<technology name=""/>
...
<part name="JP4_LED_STRIP_1" library="SparkFun" deviceset="M01" device="SMDNS" value="M01SMDNS"/>
<part name="JP5_LED_STRIP_2" library="SparkFun" deviceset="M01" device="SMDNS" value="M01SMDNS"/>
...
<part name="U$4" library="LEDCyrWheel" deviceset="ADAFRUIT_CC3000_WIFI" device=""/>
...
<sheet>
<plain>
<text x="134.62" y="30.48" size="1.778" layer="91">pin 15 and 16 should be connected together for the Octo library</text>
<text x="142.24" y="7.62" size="1.778" layer="91">screw terminal block: 2-pin, 5mm pitch, http://www.pololu.com/product/2440</text>
...
<text x="111.76" y="15.24" size="1.778" layer="91">TODO::74HCT245 :: voltage regulator for signal output from LED strip pins to 3.3v instead of 5v!!!!!</text>
</plain>
<instances>
...
<instance part="JP4_LED_STRIP_1" gate="G$1" x="48.26" y="104.14"/>
<instance part="JP5_LED_STRIP_2" gate="G$1" x="48.26" y="88.9"/>
...
<instance part="U$4" gate="G$1" x="162.56" y="66.04"/>
...
<instance part="SUPPLY4" gate="G$1" x="139.7" y="76.2"/>
</instances>
<busses>
</busses>
<nets>
...
<pinref part="JP4_LED_STRIP_1" gate="G$1" pin="1"/>
<wire x1="88.9" y1="104.14" x2="71.12" y2="104.14" width="0.1524" layer="91"/>
<pinref part="JP5_LED_STRIP_2" gate="G$1" pin="1"/>
...
<wire x1="160.02" y1="60.96" x2="81.28" y2="60.96" width="0.1524" layer="91"/>
...
<wire x1="160.02" y1="63.5" x2="83.82" y2="63.5" width="0.1524" layer="91"/>
...
<wire x1="160.02" y1="66.04" x2="86.36" y2="66.04" width="0.1524" layer="91"/>
...
<net name="WIFI_VBEN" class="0">
<segment>
<pinref part="U$4" gate="G$1" pin="VBEN"/>
...
<approved hash="204,1,160.02,71.12,U$4,3V3,,,,"/>
</errors>
</schematic>
</drawing>
<compatibility>
